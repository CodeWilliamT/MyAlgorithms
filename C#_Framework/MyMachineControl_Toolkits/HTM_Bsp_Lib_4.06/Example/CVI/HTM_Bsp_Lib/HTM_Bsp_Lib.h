...
HTM_API F64 HTM_GetCmdPos(I32 axisIdx);
HTM_API I32 HTM_SetCmdPos(I32 axisIdx, F64 cmdpos_in_unit);
HTM_API F64 HTM_GetFbkPos(I32 axisIdx);
HTM_API I32 HTM_SetFbkPos(I32 axisIdx, F64 fbkpos_in_unit);
HTM_API F64 HTM_GetCmdVel(I32 axisIdx);
HTM_API F64 HTM_GetFbkVel(I32 axisIdx);
...
HTM_API I32 HTM_OpenCom(I32 devIdx);
HTM_API I32 HTM_CloseCom(I32 devIdx);
