...
{
    public partial class MatchRegionForm : BaseForm
    {
        public MatchRegionForm()
        {
            InitializeComponent();
        ...
        private void btnExAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (mtFrm.mte_mtchRegValues.Count <= rowInd + 1)
                    mtFrm.mte_mtchRegValues.Add(vCont);
                else
                {
                    mtFrm.mte_mtchRegValues[rowInd].Dispose();
                    mtFrm.mte_mtchRegValues[rowInd] = vCont;
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnExDelete_Click(object sender, EventArgs e)
        {
            ...
            mtFrm.mte_mtchRegValues[curRowInd].Dispose();
            mtFrm.mte_mtchRegValues.RemoveAt(curRowInd);
        }
        ...
        private void dgvxDrawInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //显示轮廓
            HOperatorSet.DispObj(mtFrm.mte_mtchRegValues[e.RowIndex].obj, mtFrm.htWindow.HTWindow.HalconWindow);
        }
        ...
        void cb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //更新区域的接收类型
            mtFrm.mte_mtchRegValues[this.dgvxDrawInfo.CurrentCell.RowIndex].type = mtFrm.acceptMode[cb.SelectedIndex];
        }
    }
}
