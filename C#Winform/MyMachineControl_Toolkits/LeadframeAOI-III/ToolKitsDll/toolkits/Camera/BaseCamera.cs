...
namespace ToolKits.HTCamera
{
    ...
    public abstract class BaseCamera
    {
        ...
        public virtual bool IsCameraTrigger { get; set; }
        ...
        public virtual Acquisition Snap(int imageNum=1, int timeOut=-1) { return new Acquisition(); }
        public virtual Acquisition Hard_Snap() { return new Acquisition(); }
        public virtual Acquisition GetFrames(int imageNum = 1, int timeOut = -1) { return new Acquisition(); }
        public virtual Task<Acquisition> GetFramesAsync(int imageNum = 1, int timeOut = -1)
        {
            return Task.Run(() =>
                {
