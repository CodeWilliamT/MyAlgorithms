...
namespace ToolKits.HTCamera
{
    public class CameraMgr
    {
        ...
        {
            get { return baseCamera.IsTriggerLight; }
        }
        ...
        public CameraMgr(CameraEnum camType, string camName)
        {
            ...
            switch (camType)
            {
                ...
                case CameraEnum.BaslerVirtualToHalcon:
                    ...
                    break;
                case CameraEnum.MultiCamToHalcon:
                    baseCamera = new MultiCamToHalcon(camName);
                    break;
        ...
        public Acquisition Snap(Int32 imageNum=1, Int32 timeOut=-1)
        {
            if (baseCamera == null)
            {
        ...
        public Acquisition GetFrames(Int32 imageNum = 1, Int32 timeOut = -1)
        {
            if (baseCamera == null)
            {
                Acquisition acq = new Acquisition();
        ...
        public Task<Acquisition> GetFramesAsync(Int32 imageNum = 1, Int32 timeOut = -1)
        {
            if (baseCamera == null)
            {
                {
